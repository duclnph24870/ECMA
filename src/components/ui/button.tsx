...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        default:
          'h-[39px] max-h-[39px] min-w-[104px] rounded-[10px] bg-primary text-base text-primary-foreground hover:bg-primary/90',
        destructive:
        ...
        none: 'bg-none text-white',
        circle: 'w-[53px] rounded-full bg-white p-2.5',
      },
      size: {
